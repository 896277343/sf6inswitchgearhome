...
function getRequiredProject() {
  const matchedProject = getProjectCaseStudy("sf6-use-for-gas-insulated-switchgear-manufacturers");
  if (!matchedProject) {
...
export const metadata: Metadata = {
  title: `${project.name} | GIS Manufacturing Solutions | ${siteConfig.site_name}`,
